...
//! Idiomatic and safe types for interacting with the execution event rings.

use monad_event_ring::{
    ffi::{monad_event_ring_type, monad_event_ring_type_MONAD_EVENT_RING_TYPE_EXEC},
    EventRingType, RawEventDescriptorInfo,
};
...
pub use self::{
    ...
    consensus::{BlockCommitState, ConsensusStateTracker, ConsensusStateTrackerUpdate},
    ffi::*,
};
...
mod test {
    use monad_event_ring::{
        SnapshotEventRing, TypedEventDescriptor, TypedEventReader, TypedEventRing,
    };
