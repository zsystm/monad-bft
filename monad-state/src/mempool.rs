...
pub(super) struct MempoolChildState<'a, ST, SCT, BPT, SBT, VTF, LT, TT, BVT, ASVT>
where
    ...
    BVT: BlockValidator<SCT, BPT, SBT>,
{
    ...
    _phantom: PhantomData<(ST, SCT, BPT, VTF, LT, TT, BVT, ASVT)>,
}
...
impl<'a, ST, SCT, BPT, SBT, VTF, LT, TT, BVT, ASVT>
    MempoolChildState<'a, ST, SCT, BPT, SBT, VTF, LT, TT, BVT, ASVT>
where
    ST: CertificateSignatureRecoverable,
    SCT: SignatureCollection<NodeIdPubKey = CertificateSignaturePubKey<ST>>,
    BPT: BlockPolicy<SCT, SBT>,
