...
use monad_event_ring::{
    DecodedEventRing, EventDescriptorPayload, EventNextResult, EventRing, RawEventDecoder,
};
...
fn main() {
    ...
    let event_ring = EventRing::<RawEventDecoder>::new_from_path(event_ring_path).unwrap();
