...
pub struct monad_event_ring_header {
    ...
    pub(crate) control: monad_event_ring_control,
}
...
#[allow(non_camel_case_types)]
#[repr(C, align(64))]
pub(crate) struct monad_event_ring_control {
    pub(crate) last_seqno: u64,
    pub(crate) next_payload_byte: u64,
    align64_padding: [u8; 48],
    pub(crate) buffer_window_start: u64,
}
