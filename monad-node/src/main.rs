...
use monad_node_config::{
    FullNodeIdentityConfig, NodeBootstrapPeerConfig, NodeMetricsConfig, NodeNetworkConfig,
    ...
    let (maybe_otel_meter_provider, mut maybe_metrics_ticker) = node_state
        ...
        .map(
            |NodeMetricsConfig {
                ...
                let record_metrics_interval = Duration::from_secs(record_metrics_interval_seconds);
