...
# work around it
set(CMAKE_ASM_FLAGS "${CMAKE_ASM_FLAGS} -march=haswell")
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -march=haswell")
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -march=haswell -DQUILL_ACTIVE_LOG_LEVEL=QUILL_LOG_LEVEL_CRITICAL")
...
# cmake 4.0 compatibility workaround
