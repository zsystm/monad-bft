...
pub struct ParentExecutor<R, T, L, C, S, TP, CP, LO, SS, CL> {
    pub router: R,
    pub timer: T,
    pub ledger: L,
    pub checkpoint: C,
...
impl<RE, TE, LE, CE, SE, TPE, CPE, LOE, SSE, CLE, E, OM, ST, SCT, EPT, BPT, SBT> Executor
    for ParentExecutor<RE, TE, LE, CE, SE, TPE, CPE, LOE, SSE, CLE>
where
...
impl<E, R, T, L, C, S, TP, CP, LO, SS, CL> Stream
    for ParentExecutor<R, T, L, C, S, TP, CP, LO, SS, CL>
where
...
impl<R, T, L, C, S, TP, CP, LO, SS, CL> ParentExecutor<R, T, L, C, S, TP, CP, LO, SS, CL> {
