...
use crate::{aggregation_tree::BlsSignatureCollection, BlsAggregateSignature, scaled_aggregation_tree::ScaledBlsSignatureCollection};
...
impl<PT: PubKey> From<&ScaledBlsSignatureCollection<PT>> for ProtoBlsSignatureCollection {
...
impl<PT: PubKey> TryFrom<ProtoBlsSignatureCollection> for ScaledBlsSignatureCollection<PT> {
    type Error = ProtoError;
