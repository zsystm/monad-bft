...
const TCP_INCOMING_MAX_CONNECTIONS: usize = 10;
...
const TCP_OUTGOING_MAX_CONNECTIONS: usize = 10;
...
const TCP_MESSAGE_LENGTH_LIMIT: usize = 128 * 1024 * 1024;

const TCP_HEADER_TIMEOUT: Duration = Duration::from_secs(2);
const TCP_MESSAGE_TIMEOUT: Duration = Duration::from_secs(15);
