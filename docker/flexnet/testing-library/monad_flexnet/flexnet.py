    ...
    def run(self, runtime: int | None = None, blocking: bool = False, gen_config: bool = True):
        ...
        if gen_config:
            ...
            def copy_profile(node: Node):
                shutil.copy(pathlib.Path(f'{os.getcwd()}/../devnet/monad/config/profile.json'), self.root_dir / node.name / 'config' / 'profile.json')
                shutil.copy(pathlib.Path(f'{os.getcwd()}/../devnet/monad/config/genesis.json'), self.root_dir / node.name / 'config' / 'genesis.json')
                shutil.copy(pathlib.Path(f'{os.getcwd()}/../devnet/monad/config/genesis.toml'), self.root_dir / node.name / 'config' / 'genesis.toml')
            ...
            def create_config(node: Node):
                shutil.copytree(pathlib.Path(f'{os.getcwd()}/../devnet/monad/config'), self.root_dir / node.name / 'config')
